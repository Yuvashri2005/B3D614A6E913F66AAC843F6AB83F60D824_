'''Implement a class called BankAccount that represents a bank account. The class should have a
...
BankAccount and class test the deposit and withdraw functionality.'''
...
class BankAccount:
  ...
  def deposit(self, amount):
    if amount > 0:
      ...
      print("Invaild deposit amount. please deposit a positive amount.")
